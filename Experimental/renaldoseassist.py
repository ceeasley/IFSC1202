...
while True:
	...
	if drug not in lower:
		...
		if drug == "acyclovir" or drug == "zovirax":
			...
			if dialysis == "Y" or crcl < 15:
				...
				dose = None
				interval = None
				indication = int(input("Is the indication (1) DVT/PE, (2) non-valvular atrial fibrillation, (3) stable CAD or chronic PAD, or (4) VTE prophylaxis or indefinite anticoagulation after 6 months of therapeutic anticoagulation?: "))
				if indication != 1 and indication != 2 and indication != 3 and indication != 4:
					indication = int(input("Please enter a number. Is the indication (1) DVT/PE, (2) non-valvular atrial fibrillation, (3) stable CAD or chronic PAD, or (4) VTE prophylaxis or indefinite anticoagulation after 6 months of therapeutic anticoagulation?: "))
				if indication == 1:
					if crcl >= 30:
	...
	answer = str.upper(input("Would you like to enter another? (Y/N): "))
